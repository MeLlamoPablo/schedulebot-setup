...
var EHerokuSetApiKeyResult;
(function (EHerokuSetApiKeyResult) {
    EHerokuSetApiKeyResult[EHerokuSetApiKeyResult["SUCCESS"] = 1] = "SUCCESS";
    EHerokuSetApiKeyResult[EHerokuSetApiKeyResult["WRONG_KEY"] = 2] = "WRONG_KEY";
    EHerokuSetApiKeyResult[EHerokuSetApiKeyResult["WRONG_APP_NAME"] = 3] = "WRONG_APP_NAME";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    else if (e_1.statusCode === 403) {
                        return [2 /*return*/, EHerokuSetApiKeyResult.WRONG_APP_NAME];
                    }
                    else {
                        throw e_1;
                    }
